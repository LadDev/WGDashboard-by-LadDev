...
//ADMIN SETTINGS
export const POST_ADMIN_CHANGE_THEME = "/admin/change-theme";
export const POST_ADMIN_CHANGE_LANG = "/admin/change-lang";
export const POST_CHANGE_LIST_TYPE = "/admin/change-list-type";
export const POST_CHANGE_REFRESH_TIME = "/admin/change-interval-time";

//CONFIG
export const GET_SERVER_STATUS = "/show/status";
export const GET_CONFIGS_LIST = "/show/configs";
export const GET_CONFIG = "/config/get";
export const CHECK_IP_ADDRESS = "/config/address-check";
export const CHECK_PORT = "/config/port-check";
export const CHECK_NAME = "/config/name-check";
export const ADD_NEW_CONFIG = "/config/new";
export const POST_SWITCH_CONFIG_STATUS = "/config/change-status";
export const POST_ADD_NEW_PEER = "/peer/new";
export const POST_GET_AVAILABLE_IPS = "/config/available-ips";
export const POST_DELETE_PEER = "/peer/delete";
export const GET_CONFIG_CHART = "/config/chart-data";
export const GET_PEER_CHART = "/peer/chart-data";
export const POST_CHANGE_PEER_STATE = "/peer/change-state";
export const POST_UPDATE_PEER_SETTINGS = "/peer/save-settings";
export const GET_CONFIG_TOOLS = "/config/tools";
export const POST_PING = "/config/tools/ping";
export const POST_TRACEROUTE = "/config/tools/traceroute";
export const POST_UPDATE_GLOBAL_CONFIG = "/server/update/global";
export const POST_UPDATE_ACCOUNT_DATA = "/auth/update-data";
