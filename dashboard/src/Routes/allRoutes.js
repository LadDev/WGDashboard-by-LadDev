...
import SettingsServer from "../pages/Configurations/SettingsServer";
...
const authProtectedRoutes = [
    {path: "/home", component: <Configuration/>},
    {path: "/wireguard/:name", component: <WireGuard/>},
    {path: "/settings", component: <SettingsServer/>},
